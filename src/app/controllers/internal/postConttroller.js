...
import { createRegisterWhenDocumentSigned, GetDocument, updateRegisterWhenDocumentSigned } from '../../connection/externalConnections/autentique.js';
...
class PostController {
    ...
    async sender(req, res) {
        try {
            ...
            if (register) await updateRegisterWhenDocumentSigned(register, data.user.name, signed);
